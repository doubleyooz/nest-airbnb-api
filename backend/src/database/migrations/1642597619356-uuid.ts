...
export class uuid1642597619356 implements MigrationInterface {
    name = 'uuid1642597619356'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying NOT NULL, "references" character varying, "city" character varying NOT NULL, "state" character varying NOT NULL, "zipCode" character varying NOT NULL, "country" character varying NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "profile" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "gender" character varying NOT NULL, "governmentID" character varying, "phoneNumber" character varying NOT NULL, "emergencyContact" character varying, "nationality" character varying, "addressId" uuid, "accountId" uuid, CONSTRAINT "REL_14e847e346e37ff3da35078a6c" UNIQUE ("addressId"), CONSTRAINT "REL_36059b560e94dbaa061527a85c" UNIQUE ("accountId"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "host" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "placeType" integer NOT NULL, "description" integer NOT NULL, "privacy" integer NOT NULL, "guests" integer NOT NULL, "beds" integer NOT NULL, "bedrooms" integer, "bathrooms" integer NOT NULL, "privateBathrroms" boolean NOT NULL, "standoutAmenities" character varying array NOT NULL, "guestFavorites" character varying array NOT NULL, "safetyItems" character varying array NOT NULL, "photos" character varying array NOT NULL, "title" character varying NOT NULL, "highlights" character varying array NOT NULL, "descriptionText" character varying NOT NULL, "price" integer NOT NULL, "odds" boolean array NOT NULL, "addressId" uuid, CONSTRAINT "REL_879682fc0e684dc7d7d8ff080e" UNIQUE ("addressId"), CONSTRAINT "PK_44424c24c2f9b1d7bbf8721f4c4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "password" character varying NOT NULL, "email" character varying NOT NULL, "birthDate" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "tokenVersion" integer NOT NULL DEFAULT '1', "profileIDId" uuid, "hostIDId" uuid, CONSTRAINT "UQ_4c8f96ccf523e9a3faefd5bdd4c" UNIQUE ("email"), CONSTRAINT "REL_7a6053fb7984753404736a2fc6" UNIQUE ("profileIDId"), CONSTRAINT "REL_54c4d580837b3458c0451590bb" UNIQUE ("hostIDId"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
